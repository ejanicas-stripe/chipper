...
Chipper is an example app, which you can use to familiarize yourself with the SDK and reader for your own integration.
...
1. Open `Example.xcworkspace` (make sure to open the **`.xcworkspace`** and not the `.xcodeproj`).
2. Navigate to the [example backend](https://github.com/ejanicas-stripe/chipper-backend) and deploy it.
3. In `AppDelegate.swift`, set the URL of the app you just deployed.
