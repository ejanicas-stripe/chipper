...
class StartPaymentViewController: TableViewController, CancelingViewController {
    ...
    private func updateContent() {
        ...
        let paymentMethodSection = Section(header: Section.Extremity.title("Payment Method"), rows: [], footer: shouldShowTestCardPickerView ? Section.Extremity.autoLayoutView(TestCardPickerView()) : nil)
